class Progression(object):
    ...
    def _advance(self):
        ...
        This should be overridden by a subsclass to customize progression.
...
class FibonacciProgression(Progression):
    ...
    def _advance(self):
        ...
        _tmp_current = self._current
        self._current = self._prev + self._current
        self._prev = _tmp_current


if __name__ == "__main__":
    FibonacciProgression().print_progression(10)
    FibonacciProgression(4, 5).print_progression(10)
